...
FTTEMPDIR='mktemp /tmp/fteller.XXX'
...
echo -q0- "$(wget http://fortunecookieapi.herokuapp.com/v1/fortunes)" >> $FTTEMPDIR
...
cat fortunes >  $FTTEMPDIR/fortunes_pp
...
cut -wc fortunes_message > NUMMSG
...
CHOSEN=$1
$ echo $(( $RANDOM % NUMMSG + 1 )) CHOSEN | bc
